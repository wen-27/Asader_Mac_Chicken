...
PRODUCT_SEEDS: tuple[ProductSeed, ...] = (
    ...
    ProductSeed("POSTOBON_25", "Postobon 2.5 L", ProductCategory.BEBIDAS, 8500),
...
PRODUCT_ALIAS_SEEDS: tuple[ProductAliasSeed, ...] = (
    ...
    ProductAliasSeed("POSTOBON_25", ("postobon 2.5", "postobon dos litros y medio", "postobon 2 litros y medio")),

...
def build_natural_order_prompt(message: str, catalog_context: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "- 'coca-cola 1.5', 'coca 1.5', 'gaseosa litro y medio' => LITRO_MEDIO quantity 1.",
            ...
            'JSON: {"intent":"order_items","items":[{"code":"ASADO_ENTERO","quantity":1},{"code":"LITRO_MEDIO","quantity":1}],"customer":{"name":"","phone":"","address":"","neighborhood":"","paymentMethod":""},"wantsCheckout":false,"confidence":0.95,"notes":[]}',
            'Mensaje: "Quiero un pollo asado con adicional de papas fritas y una Cocacola 1.5"',
            'JSON: {"intent":"order_items","items":[{"code":"ASADO_ENTERO","quantity":1},{"code":"PAPA_FRANCESA","quantity":1},{"code":"LITRO_MEDIO","quantity":1}],"customer":{"name":"","phone":"","address":"","neighborhood":"","paymentMethod":""},"wantsCheckout":false,"confidence":0.95,"notes":[]}',

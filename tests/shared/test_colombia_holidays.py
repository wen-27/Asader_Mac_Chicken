...
from app.shared.utils.colombia_holidays import (
    colombian_public_holidays,
    is_colombian_monday_holiday,
    is_colombian_public_holiday,
)
...
def test_non_monday_public_holiday_is_detected() -> None:
    assert date(2026, 8, 7) in colombian_public_holidays(2026)
    assert is_colombian_public_holiday(date(2026, 8, 7))
